...
const LITERAL_GRID: LadderGrid = Object.freeze({
  owner: Object.freeze({
    ...
    manage_agents: true,
    invoke_agents: true,
    invoke_other_agents: true,
    use_personal_provider_credentials: true,
    use_server_provider_credentials: true,
    create_rooms: true,
    manage_rooms: true,
    ...
    timeout_server_members: true,
    kick_server_members: true,
    ban_server_members: true,
    view_server_moderation: true,
    manage_server_enrollment: true,
    timeout_room_members: true,
    kick_room_members: true,
    ban_room_members: true,
    view_room_moderation: true,
  ...
  superuser: Object.freeze({
    ...
    timeout_server_members: false,
    kick_server_members: false,
    ban_server_members: false,
    view_server_moderation: false,
    manage_server_enrollment: false,
    timeout_room_members: false,
    kick_room_members: false,
    ban_room_members: false,
    view_room_moderation: false,
    use_project_content: true,
    use_project_execution: true,
    use_workstation: true,
    use_remote_hosts: true,
  ...
  community: Object.freeze({
    ...
    manage_agents: false,
    invoke_agents: true,
    invoke_other_agents: false,
    use_personal_provider_credentials: true,
    use_server_provider_credentials: false,
    create_rooms: true,
    manage_rooms: false,
    read_server_settings: false,
    manage_server_operations: false,
  ...
  guest: Object.freeze({
    ...
    invoke_agents: false,
    invoke_other_agents: false,
    use_personal_provider_credentials: false,
    use_server_provider_credentials: false,
    create_rooms: false,
    manage_rooms: false,
    read_server_settings: false,

...
export const group_load_device_state: (a: number, b: number, c: number) => [number, number, number];
export const group_member_roster: (a: number) => [number, number];
...
export const group_propose_and_commit_remove: (a: number, b: number, c: number, d: number) => [number, number, number];
export const group_propose_and_commit_update: (a: number, b: number, c: number) => [number, number, number];
export const identity_key_package: (a: number, b: number) => [number, number, number];
export const identity_load: (a: number, b: number) => [number, number, number];
...
export const keypackage_to_bytes: (a: number) => [number, number, number, number];
export const provider_deserialize_device_state: (a: number, b: number) => [number, number, number];
export const provider_new: () => number;
export const provider_serialize_device_state: (a: number) => [number, number, number, number];
export const ratchettree_from_bytes: (a: number, b: number) => [number, number, number];
export const ratchettree_to_bytes: (a: number) => [number, number, number, number];

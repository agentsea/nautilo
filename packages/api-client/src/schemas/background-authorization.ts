...
export const BACKGROUND_AUTHORIZATION_MAX_REQUEST_WIRE_BYTES = Math.max(
  MAX_ANY_BACKGROUND_PROCESSOR_WORK_DESCRIPTOR_WIRE_BYTES_V2,
  MAX_TASK_RUNTIME_BACKGROUND_AUTHORIZATION_REQUEST_WIRE_BYTES_V1,
);
export const BACKGROUND_AUTHORIZATION_MAX_RESPONSE_WIRE_BYTES = Math.max(
  MAX_BACKGROUND_AUTHORIZATION_RESPONSE_WIRE_BYTES_V2,
...
export const BACKGROUND_AUTHORIZATION_MAX_RESPONSE_CHARACTERS =
  maximumBase64urlCharacters(
    BACKGROUND_AUTHORIZATION_MAX_RESPONSE_WIRE_BYTES,
  );

...
describe('clipboard JSON serialization', () => {
  ...
  it('should include version in payload', () => {
    ...
    const payload = JSON.parse(json) as { version: number };
...
describe('clipboard payload validation', () => {
  ...
  it('preserves nonnegative list levels beyond the former indent ceiling', () => {
    expect(parseOne({ type: 'list-item', listLevel: 5000 }).listLevel).toBe(5000);

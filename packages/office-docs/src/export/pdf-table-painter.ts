...
import type { NestedWork } from '../view/nested-work.js';
...
export type NestedPaintCellContent = (
  ...args: Parameters<PaintCellContent>
) => NestedWork<void>;
 ...
 */
export function* paintTablePageRangeWork(
  page: PDFPage,
  ...
  pageHeightPt: number,
  paintCellContent: NestedPaintCellContent,
): NestedWork<void> {
...
export function* paintTableRowsWork(
  page: PDFPage,
  tableData: TableData,
  layoutTable: LayoutTable,
  tableX: number,

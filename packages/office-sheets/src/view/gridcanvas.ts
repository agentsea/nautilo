...
export class GridCanvas {
  ...
  private renderHeader(
    ...
    // Nautilo: match text to the active header background, independent of grid mode.
    ctx.fillStyle = this.getThemeColor(
      selected && !fullSelected ? 'headerActiveTextColor' : 'cellTextColor',
    );

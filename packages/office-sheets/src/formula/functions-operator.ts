...
import { EvalNode, ErrNode, NumNode, numNode } from './formula';
...
const eqFunc = comparisonFunc('eq');
const neFunc = comparisonFunc('ne');
const ltFunc = comparisonFunc('lt');
const lteFunc = comparisonFunc('lte');
const gtFunc = comparisonFunc('gt');
const gteFunc = comparisonFunc('gte');

/* eslint-disable @typescript-eslint/require-await -- Modified by Nautilo: this in-memory Store keeps the public asynchronous Store contract without manufacturing awaits. */
...
export class MemStore implements Store {
  ...
  constructor(grid?: Grid) {
    this.grid = grid ?? new Map<Sref, Cell>();
    this.rebuildIndex();
  }

/* eslint-disable @typescript-eslint/require-await -- Modified by Nautilo: this synchronous read-only adapter preserves the public asynchronous Store contract. */

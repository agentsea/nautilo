// Modified by Nautilo: resolve the worker runner through hoisted workspace dependencies.
...
function startWorker() {
  const child: ChildProcessWithoutNullStreams = spawn(process.execPath, [TSX, WORKER], {

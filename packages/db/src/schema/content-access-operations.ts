 ...
 * The table owner needs UPDATE/DELETE privileges for FK-driven anonymization
 * and retirement. The immutable receipt trigger, not revoked owner DML,
 * rejects direct mutation; TRUNCATE remains denied. SQL-only privileges are
 * generated by db:generate:content-access-fk-permissions.
 */

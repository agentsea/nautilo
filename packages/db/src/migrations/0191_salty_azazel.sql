ALTER TABLE "reflection_record_semantic_work" DROP CONSTRAINT "reflection_record_semantic_work_reason_closed_v2";--> statement-breakpoint
ALTER TABLE "reflection_record_semantic_work" ADD CONSTRAINT "reflection_record_semantic_work_reason_closed_v2" CHECK ("reflection_record_semantic_work"."change_reason" in (

ALTER TABLE "encryption_transition_boundary_health" DROP CONSTRAINT "encryption_transition_boundary_health_shape";--> statement-breakpoint
ALTER TABLE "encryption_transition_boundary_health" ADD CONSTRAINT "encryption_transition_boundary_health_shape" CHECK ("encryption_transition_boundary_health"."policy_revision" > 0

...
ALTER TABLE "conversation_shadow_turn_operations" ALTER COLUMN "namespace_binding_hash" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ALTER COLUMN "binding_revision_at_wrap" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ALTER COLUMN "domain_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ALTER COLUMN "domain_epoch" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "committer_device_signing_key_generation" bigint;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "namespace_authority_scheme" text DEFAULT 'domain_root_v1' NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "namespace_head_digest" "bytea";--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "namespace_publication_digest" "bytea";--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "namespace_publication_set_digest" "bytea";--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "namespace_audience_fingerprint" "bytea";--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "agent_grant_plan_bytes" "bytea";--> statement-breakpoint
ALTER TABLE "conversation_shadow_turn_operations" ADD COLUMN "agent_grant_plan_digest" "bytea";--> statement-breakpoint
...
ALTER TABLE "conversation_shadow_turn_operations" ADD CONSTRAINT "conversation_shadow_turn_operations_coordinate_shape" CHECK ("conversation_shadow_turn_operations"."policy_revision" > 0
        ...
        and ("conversation_shadow_turn_operations"."domain_epoch" is null or "conversation_shadow_turn_operations"."domain_epoch" >= 0));--> statement-breakpoint
...
BEGIN
  IF ROW(
    ...
    NEW.namespace_audience_fingerprint, NEW.agent_grant_plan_bytes,
    ...
    OLD.namespace_audience_fingerprint, OLD.agent_grant_plan_bytes,

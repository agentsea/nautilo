...
/** @typedef {Record<string, number>} GuideTable */
/** @typedef {{ l: number, t: number, r: number, b: number }} TextRect */
/** @typedef {{ kind: string, rect?: TextRect, skipped?: boolean }} GeneratedRow */
...
/**
 * @param {GeneratedRow} row
 * @returns {row is GeneratedRow & { rect: TextRect }}
 */
function hasRect(row) {
  return row.rect !== undefined;
}

/** @param {GeneratedRow[]} rows */

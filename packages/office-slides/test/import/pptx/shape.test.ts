...
<p:sld xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"
  ...
  it('reports a theme effect reference that cannot be resolved into native effects', async () => {
    const xml = `<p:sld xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><p:cSld><p:spTree><p:sp><p:nvSpPr><p:cNvPr id="2" name="Shadowed"/><p:cNvSpPr/><p:nvPr/></p:nvSpPr><p:spPr><a:xfrm><a:off x="0" y="0"/><a:ext cx="100" cy="100"/></a:xfrm><a:prstGeom prst="rect"><a:avLst/></a:prstGeom></p:spPr><p:style><a:effectRef idx="2"><a:schemeClr val="accent1"/></a:effectRef></p:style></p:sp></p:spTree></p:cSld></p:sld>`;
    const report = new ImportReport();
    await parseSlide({ archive: makeArchive({ 'ppt/slides/slide1.xml': xml }), partPath: 'ppt/slides/slide1.xml', layoutMap: new Map(), scale: { sx: 1, sy: 1 }, report, clrMap: new Map() });
    expect(report.summary()).toContain('1 shape theme effect(s) omitted');
  });
});

...
describe('importPptx', () => {
  it('imports a minimal deck — theme/master/layout/slide all wired', async () => {
    ...
    expect(document.layouts.every(layout => masterIds.has(layout.masterId))).toBe(true);
    ...
    expect(document.slides[0].layoutId).toBe('imported-ppt/slideLayouts/slideLayout1.xml');

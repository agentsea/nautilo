...
/**
 * Shared precise-pointer movement threshold. A mouse/pen gesture at or above
 * this client-pixel distance counts as a drag and is no longer eligible for
 * slow-double-click text entry. Grid snapping also stays inactive below it.
 * Keeping those decisions on one canonical value prevents a gesture from
 * being treated as a click by one path and a drag by another.
 *

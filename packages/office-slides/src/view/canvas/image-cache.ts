...
import { loadImage } from '@nautilo/office-core/image';
 ...
 * `@nautilo/office-core/image`, because the CORS-then-retry ordering is subtle
...
export function getOrLoadImage(
  ...
  // CORS first, plain retry on failure (@nautilo/office-core/image). Our own

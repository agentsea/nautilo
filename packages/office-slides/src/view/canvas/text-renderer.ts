 ...
 *
 * Layout AND painting are delegated to `@nautilo/office-docs` so that the
 ...
 */
function isTextBodyEmpty(body: TextBody): boolean {
 ...
 * `@nautilo/office-docs.paintLayout` so all surfaces produce pixel-identical
 * output.
 *

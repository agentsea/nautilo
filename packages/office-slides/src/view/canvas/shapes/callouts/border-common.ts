...
/** Exact DrawingML signed-coordinate bounds; snapping uses one frame axis (100000 units). */
export const OOXML_CALLOUT_COORD_MIN = -2147483647;
export const OOXML_CALLOUT_COORD_MAX = 2147483647;
export const Y_BOUND = { min: OOXML_CALLOUT_COORD_MIN, max: OOXML_CALLOUT_COORD_MAX, snapRange: 100000 } as const;
export const X_BOUND = { min: OOXML_CALLOUT_COORD_MIN, max: OOXML_CALLOUT_COORD_MAX, snapRange: 100000 } as const;

...
import { OOXML_CALLOUT_COORD_MAX, OOXML_CALLOUT_COORD_MIN } from './border-common';
...
export const WEDGE_ELLIPSE_CALLOUT_ADJUSTMENTS: readonly AdjustmentSpec[] = [
  { name: 'Tail x', defaultValue: -20833, min: OOXML_CALLOUT_COORD_MIN, max: OOXML_CALLOUT_COORD_MAX, snapRange: 100000 },
  { name: 'Tail y', defaultValue: 62500, min: OOXML_CALLOUT_COORD_MIN, max: OOXML_CALLOUT_COORD_MAX, snapRange: 100000 },
];

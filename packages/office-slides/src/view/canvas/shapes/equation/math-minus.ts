...
export const MATH_MINUS_ADJUSTMENTS: readonly AdjustmentSpec[] = [
  { name: "Bar thickness", defaultValue: 23520, min: 0, max: 100000 },
];

const MP_MIN = MATH_MINUS_ADJUSTMENTS[0].min;
const MP_MAX = MATH_MINUS_ADJUSTMENTS[0].max;
const MP_DEF = MATH_MINUS_ADJUSTMENTS[0].defaultValue;

import type { PathBuilder, AdjustmentHandle, AdjustmentSpec } from "../builder";
import { adj } from "../builder";
import { insetAlongAxis } from "../handles";

export const MATH_MULTIPLY_ADJUSTMENTS: readonly AdjustmentSpec[] = [
  { name: "Arm thickness", defaultValue: 23520, min: 0, max: 51965 },
];
...
const MM_MIN = MATH_MULTIPLY_ADJUSTMENTS[0].min;
const MM_MAX = MATH_MULTIPLY_ADJUSTMENTS[0].max;
const MM_DEF = MATH_MULTIPLY_ADJUSTMENTS[0].defaultValue;

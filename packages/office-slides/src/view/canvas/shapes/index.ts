...
import { buildMathMinus, MATH_MINUS_ADJUSTMENTS, MATH_MINUS_HANDLES } from './equation/math-minus';
import { buildMathMultiply, MATH_MULTIPLY_ADJUSTMENTS, MATH_MULTIPLY_HANDLES } from './equation/math-multiply';
import {
  buildMathDivide,
...
ADJUSTMENT_SPECS.set('mathMinus', MATH_MINUS_ADJUSTMENTS);
ADJUSTMENT_SPECS.set('mathMultiply', MATH_MULTIPLY_ADJUSTMENTS);

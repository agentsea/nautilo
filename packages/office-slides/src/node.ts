...
// DOM-free public surface for `@nautilo/office-slides`.
//
...
//
// Wired in two places:
//   - `packages/backend/tsconfig.json` paths map `@nautilo/office-slides`
...
//     subpath (`@nautilo/office-slides/node`) for downstream consumers
...
// `@nautilo/office-slides`; the slides `.integration.ts` suite runs that store
...
export { CURVE_BEND_DEFAULT } from './view/canvas/routing';
...
export { BUILT_IN_THEMES } from './themes/index';
...
// PPTX import — best-effort. Browser builds use their native DOMParser;
// Node builds use the package-local parser without mutating global state.
...
export { validateSlidesPdf } from './export/pdf-validation';

// Modified by Nautilo on 2026-09-13: pure Board geometry/import dependencies.
export type { ArrowheadKind, ArrowheadStyle, Endpoint } from './model/connector';
export { DIR_E, DIR_N, DIR_S, DIR_W } from './model/connection-site';
export { connectionSitesForKind, siteWorldPos } from './view/canvas/connection-sites';
export { worldToScreen, screenToWorld, type Viewport } from './view/canvas/viewport';
export { getActiveTheme } from './view/canvas/render-context';

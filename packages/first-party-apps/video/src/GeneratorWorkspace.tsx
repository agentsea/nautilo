...
import { assetForGenerationReference, beginSceneDesign, referenceExtraInstructions, referenceMentions, setSimpleGenerationPrompt, simpleGenerationPrompt } from "./generator-composer";

 ...
 * it — e.g. a no-op `broadcast` poisoning ws-publisher delivery tests. The same
 * code then passes locally and fails in CI purely on file-discovery order
 * (macOS vs Linux walk the directory differently). We lost hours to exactly
 * this (the D261 TtsService leak).
 *

/**
 * Workstation Profile review and activation-preparation IPC wiring checks.
 *
...
describe("uncontained-host-command IPC", () => {
  ...
  test("relay admission rechecks the main-owned exact status before the workstation runner", () => {

...
const BROWSER_VISUAL_GROUNDING_RELATIVE_PATH = join(
  "Contents", "Resources", "tools-browser-vision", "nautilo-browser-visual-grounding",
);
const BROWSER_VISUAL_GROUNDING_ENTITLEMENTS = resolve(
  __dirname, "..", "entitlements.browser-visual-grounding.plist",
);
const BROWSER_VISUAL_GROUNDING_IDENTIFIER = "com.nautilo.desktop.browser-visual-grounding";

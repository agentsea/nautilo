...
export function MediaPickerWaveform({ peaks }: { peaks: readonly number[] }): ReactElement {
  ...
  return <svg ref={svg} className="h-16 w-full text-foreground" role="img" aria-label="Audio waveform" viewBox={`0 0 ${width} 64`} preserveAspectRatio="none">
